...
def download_and_upsert_F99():
    ...
    print(f"[F99] Số dòng sau khi lọc từ 01/01/2024: {len(df)}")
    ...
    for i in range(0, total_rows, chunk_size):
        ...
        upsert_data2datalake(df=chunk, tablename='"NetSuite"."F99_CustomSearch_4532"', primary_key='filename')

def upsert_F99_to_warehouse():
    import pandas as pd

    query = """
        SELECT * FROM "NetSuite"."F99_CustomSearch_4532"
    ...
    try:
        ...
        for i in range(0, total_rows, chunk_size):
            ...
            upsert_data2datawarehouse(
                df=chunk,
                tablename='"NetSuite"."F99_CustomSearch_4532"',
...
with DAG(
    dag_id='NetSuite_Daily_ToWarehouse_F99',
